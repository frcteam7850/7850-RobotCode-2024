...
//Class
public class ShooterIntakeRevCmd extends Command {
private final IntakeSubsystem m_IntakeSubsystem;
private boolean intakeButtonPressed;
public boolean ButtonStatusVar;

 public ShooterIntakeRevCmd(IntakeSubsystem subsytem, boolean released) {
  ...
  public void execute() {
    if(intakeButtonPressed){
     m_IntakeSubsystem.RunShooterIntake(true);
     ButtonStatus(true);
    }
    else {
